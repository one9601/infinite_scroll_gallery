...
//   $wr_8 = get_vimeoThumb($view['wr_9']);
 
//   $sql = "UPDATE portfolio SET wr_8='{$wr_8}' WHERE wr_id={$wr_id}";
//   sql_query($sql);
...
;
    ...
    <section id="bo_v_atc">
        ...
        <main> 
            <div class='portfolio_view_contents'>
            <?php if($view['wr_10']){ ?>
                <div class="iframe_box">
                    <iframe src="https://www.youtube.com/embed/<?php echo $view['wr_10'] ?>?autoplay=1" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                </div>
            <?php } else if($view['wr_9']){ ?>
                <div class="iframe_box">
                    <iframe src="https://player.vimeo.com/video/<?php echo $view['wr_9'] ?>?autohide=1&autoplay=1&vq=hd720&loop=1" frameborder="0" allow="accelerometer; autoplay; encrypted-media; gyroscope; picture-in-picture" allowfullscreen=""></iframe>
                </div>
            <?php } else {
                // 파일 출력
            ...
            <?php if($view['wr_3'] != ""){ ?>
            <p class='portfolio-hp-linkBox'>
              <a href="<?=$view['wr_3']?>" class='portfolio-hp-link' target="_blank">
                <?=$view['wr_3']?>
              </a>
            </p>
            <?php } ?>
